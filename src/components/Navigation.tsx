const Navigation = (props: {
  ...
  return (
    <ul className={`navigation-list ${props.toggleClass}`}>
      <li onClick={props.onWelcome}>Welcome</li>
      <li onClick={props.onProjects}>Projects</li>
      <li>
        <div className="icon-container">
          ...
          <a href="mailto:trgtgokhan@gmail.com">
            <svg
              width="24"
              height="24"
              xmlns="http://www.w3.org/2000/svg"
